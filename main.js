...
console.log(numbersOver10(numbers))
...
console.log(numbersOverX(numbers, 15).toString());
...
for ( var i = 0; i < array.length; i++ ) {
        ...
        basketOne.push(array[i]);

}

for ( var e = 0; e < arrayTwo; e++ ){

        basketTwo.push(arrayTwo[e]);
}

          var newBasket = basketOne.concat(basketTwo);
